...
# 创建对应功能的对象
hand = mp_hand.Hands()
landmark_style = mp_draw.DrawingSpec(color=(255, 0, 0), thickness=3, circle_radius=3)
connection_style = mp_draw.DrawingSpec(color=(0, 255, 0), thickness=3)
...
while cap.isOpened():
    ...
    if mul_hand_landmarks is not None:
        ...
        for hand_landmarks in mul_hand_landmarks:
            # 将手部关键点绘制出来
            mp_draw.draw_landmarks(frame, hand_landmarks, mp_hand.HAND_CONNECTIONS, landmark_style, connection_style)
